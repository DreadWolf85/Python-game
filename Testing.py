...
def loopSound():
    while True:
        playsound("C:\\Users\\liver\\OneDrive\Desktop\\Team Game\\game audio\\The_Dark_Castle.wav", block=True)
...
while True:
    ...
    if age >= 16:
        ...
        if answer == "h":
            playsound("C:\\Users\\liver\\OneDrive\\Desktop\\Team Game\\game audio\\Horse-Neighing.wav")
            print("")       
            print("                                                                                                                     {)                                                      ")
            print("                                                                                                                  c==//\                                                      ")
            print("                                                                                                             _-~~/-._|_|                                                          ")
            ...
            if answer == "r":
                ...
                playsound("C:\\Users\\liver\\OneDrive\Desktop\\Team Game\\game audio\\Death_Scream.wav")
                sys.exit()
            elif answer == "k":
                playsound("C:\\Users\liver\\OneDrive\Desktop\\Team Game\\game audio\\Drawing_sword.wav")
                playsound("C:\\Users\\liver\OneDrive\Desktop\\Team Game\\game audio\\Body-Dropping.wav")
                print("")
                ...
                while True:
                    if answer == "y":
                        print(Fore.GREEN +"")
                        playsound("C:\\Users\\liver\\OneDrive\\Desktop\\Team Game\\game audio\\Magic-Spell.wav")
                    ...
                    while True:
                        ...
                        if answer == "k "or" mi": 
                            ...
                            if answer == "y":
                                ...
                                playsound("C:\\Users\liver\\OneDrive\\Desktop\\Team Game\\game audio\\Blood-Squirt.wav")
                                playsound("C:\\Users\\liver\\OneDrive\Desktop\\Team Game\\game audio\\Death_Scream.wav")
                                sys.exit()
                            ...
                            if answer == "a":
                                    ...
                                    print(Fore.GREEN +"")
                                    playsound("C:\\Users\liver\\OneDrive\\Desktop\\Team Game\\game audio\\run.wav")
        ...
        #Walking path
            ...
            playsound("C:\\Users\\liver\\OneDrive\Desktop\\Team Game\\game audio\\footsteps.wav",)
